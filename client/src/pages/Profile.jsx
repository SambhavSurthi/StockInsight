...
const Profile = () => {
  ...
  return (
    <div className="mx-auto flex max-w-xl flex-col gap-6 px-4 py-6 lg:max-w-3xl lg:gap-8 lg:p-8 lg:border lg:rounded-2xl lg:bg-card lg:shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
        ...
        <div className="space-y-2 rounded-lg border bg-card lg:bg-background/50 p-4">
          ...
          <div className="flex flex-col gap-3">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-xs text-muted-foreground ml-auto">Dec 04, Dec 03</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                type="radio"
              ...
              <span className="text-xs text-muted-foreground ml-auto">Dec 01, Dec 02</span>
            </label>
          </div>
        </div>
